// Credit: https://github.com/amit08255/circular-dashed-progress-react/tree/main
...
const CircularProgressBar: FunctionComponent<Props> = ({
  maxValue = MAX_VALUE,
  selectedValue = 0,
  ...
  const renderOuterCircle = () =>
    [...Array(maxValue + 1)].map((_, i) => renderPie(i));
